...
const initialState = { fakeConnectorEdit: [], reviewappconnectorsAPI: [] }

export default function apiReducer(state = initialState, action) {
  switch (action.type) {
    case types.FAKECONNECTOREDIT_GET_PETS_LIST:
    case types.FAKECONNECTOREDIT_GET_PETS_LIST_SUCCEEDED:
    case types.FAKECONNECTOREDIT_GET_PETS_LIST_FAILED:
      return Object.assign({}, state, {
        fakeConnectorEdit: [...state.fakeConnectorEdit, action.response]
      })
    case types.API_V1_CUSTOMTEXT_LIST:
    case types.API_V1_CUSTOMTEXT_LIST_SUCCEEDED:
    case types.API_V1_CUSTOMTEXT_LIST_FAILED:
      return Object.assign({}, state, {
        reviewappconnectorsAPI: [
          ...state.reviewappconnectorsAPI,
          action.response
        ]
      })
