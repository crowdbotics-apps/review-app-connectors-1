...
export const fakeconnectoredit_get_pets_list = () => ({
  type: types.FAKECONNECTOREDIT_GET_PETS_LIST
})
export const fakeconnectoredit_get_pets_listSucceeded = (
  response,
  starter
) => ({
  type: types.FAKECONNECTOREDIT_GET_PETS_LIST_SUCCEEDED,
  response,
  starter
})
export const fakeconnectoredit_get_pets_listFailed = (error, starter) => ({
  type: types.FAKECONNECTOREDIT_GET_PETS_LIST_FAILED,
  error,
  starter
})
